function AddIcon() {
  return (
<svg aria-labelledby="add-remove-from-cart" className="small-icon pointer-cursor" role="img" version="1.1" id="Layer_1" x="0px" y="0px"
	 viewBox="0 0 300.003 300.003" style={{enableBackground:"new 0 0 300.003 300.003"}} >
